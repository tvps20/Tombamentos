...
@$dados = $_REQUEST['msg'];
$consultar = consulta("cadastro_usuario", "*", null, "ORDER BY nome ASC", "limit 10");
        ...
        <div id="boxPrincipal">
            <div id="conteudo">
                ...
                <section id="dados">                  
                    <table id="tabela">
                        <tr>
                            <td class="topo"><a href="consultaUsuarios.php?ordem=id"/>Codigo</a></td>
                            <td class="topo"><a href="consultaUsuarios.php?ordem=nome"/>Nome</a></td>
                            <td class="topo"><a href="consultaUsuarios.php?ordem=usuario"/>usuario</a></td>
                            <td class="topo"><a href="consultaUsuarios.php?ordem=status"/>Status</a></td>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $consultar[$i]['usuario'] ?></td>
                                <td><?php echo $consultar[$i]['status'] ?></td>
                                <td><a id="ed" href="_admin/editarUsuario.php?id=<?php echo $consultar[$i]['id']; ?>">Editar</a>/<a id="ex" href="admin/processaExcluir.php?id=<?php echo $consultar[$i]['id']; ?>">Excluir</a></td>
                            </tr>
                        <?php  
                                }
                            }
